...
public class ClientHandlerThreadTest {
	...
	static void endServerSocket() throws Exception {
		...
		try {
			...
			out.writeObject(new Request(Request.Command.QUIT, Request.Direction.CLIENT_TO_SERVER, "Jen"));
	...
	void testClientJoin() throws Exception {
		...
		// When
		out.writeObject(new Request(Request.Command.JOIN, Request.Direction.CLIENT_TO_SERVER, "Jen"));
	...
	void testClientThreadStartCommand() throws Exception {
		...
		// When
		out.writeObject(new Request(Request.Command.START, Request.Direction.CLIENT_TO_SERVER, "Jen"));
	...
	void testClientThreadDrawCommand() throws Exception {
		...
		// When
		out.writeObject(new Request(Request.Command.DRAW, Request.Direction.CLIENT_TO_SERVER, "Jen"));
